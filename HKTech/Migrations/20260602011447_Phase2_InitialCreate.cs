...
{
    /// <inheritdoc />
    public partial class Phase2_InitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TdpWatt = table.Column<int>(type: "int", nullable: false),
                    BenchmarkScore = table.Column<int>(type: "int", nullable: false),
                    Socket = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    RamType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    FormFactor = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PcBuildItems_PcBuilds_BuildId",
                        column: x => x.BuildId,
